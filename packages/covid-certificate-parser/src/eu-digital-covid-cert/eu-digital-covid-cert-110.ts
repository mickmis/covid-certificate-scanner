// To parse this data:
//
//   import { Convert, EuDigitalCovidCert110 } from "./file";
//
//   const euDigitalCovidCert110 = Convert.toEuDigitalCovidCert110(json);
//
 ...
 */
export interface EuDigitalCovidCert110 {
  /**
...
export class Convert {
  public static toEuDigitalCovidCert110(json: string): EuDigitalCovidCert110 {
    return cast(JSON.parse(json), r("EuDigitalCovidCert110"));
  }

  public static euDigitalCovidCert110ToJson(value: EuDigitalCovidCert110): string {
    return JSON.stringify(uncast(value, r("EuDigitalCovidCert110")), null, 2);
  }
}
