// To parse this data:
//
//   import { Convert, EuDigitalCovidCert100 } from "./file";
//
//   const euDigitalCovidCert100 = Convert.toEuDigitalCovidCert100(json);
//
 ...
 */
export interface EuDigitalCovidCert100 {
  /**
...
export class Convert {
  public static toEuDigitalCovidCert100(json: string): EuDigitalCovidCert100 {
    return cast(JSON.parse(json), r("EuDigitalCovidCert100"));
  }

  public static euDigitalCovidCert100ToJson(value: EuDigitalCovidCert100): string {
    return JSON.stringify(uncast(value, r("EuDigitalCovidCert100")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  "TElement": o([
    { json: "ci", js: "ci", typ: "" },
    { json: "co", js: "co", typ: "" },
    { json: "dr", js: "dr", typ: u(undefined, Date) },
    { json: "is", js: "is", typ: "" },
