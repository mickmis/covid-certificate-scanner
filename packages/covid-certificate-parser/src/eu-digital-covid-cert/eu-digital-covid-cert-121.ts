// To parse this data:
//
//   import { Convert, EuDigitalCovidCert121 } from "./file";
//
//   const euDigitalCovidCert121 = Convert.toEuDigitalCovidCert121(json);
//
 ...
 */
export interface EuDigitalCovidCert121 {
  /**
...
export class Convert {
  public static toEuDigitalCovidCert121(json: string): EuDigitalCovidCert121 {
    return cast(JSON.parse(json), r("EuDigitalCovidCert121"));
  }

  public static euDigitalCovidCert121ToJson(value: EuDigitalCovidCert121): string {
    return JSON.stringify(uncast(value, r("EuDigitalCovidCert121")), null, 2);
  }
}
