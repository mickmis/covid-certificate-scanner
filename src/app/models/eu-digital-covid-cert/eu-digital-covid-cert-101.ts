// To parse this data:
//
//   import { Convert, EuDigitalCovidCert101 } from "./file";
//
//   const euDigitalCovidCert101 = Convert.toEuDigitalCovidCert101(json);
//
 ...
 */
export interface EuDigitalCovidCert101 {
  /**
...
export class Convert {
  public static toEuDigitalCovidCert101(json: string): EuDigitalCovidCert101 {
    return cast(JSON.parse(json), r("EuDigitalCovidCert101"));
  }

  public static euDigitalCovidCert101ToJson(value: EuDigitalCovidCert101): string {
    return JSON.stringify(uncast(value, r("EuDigitalCovidCert101")), null, 2);
  }
}
